...
export default function WhatWeDo({ services }: WhatWeDoProps) {
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="mt-4 text-text-secondary text-lg max-w-xl mx-auto">
              From mobile apps to virtual tours — we&apos;ve got you covered.
            </p>
          </motion.div>
          ...
          >
            {displayServices.map((service) => (
              <motion.button
                ...
                className="text-left bg-surface border border-border rounded-xl p-6 hover:border-accent hover:scale-[1.02] transition-all duration-300 group"
              >
                ...
                <h3 className="mt-4 font-syne text-xl font-semibold text-text-primary">
                  {service.name}
                </h3>
